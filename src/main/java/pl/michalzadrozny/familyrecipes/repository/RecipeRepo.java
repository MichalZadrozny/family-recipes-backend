...
public interface RecipeRepo extends JpaRepository<Recipe, Long> {
    ...
    @Query("SELECT new pl.michalzadrozny.familyrecipes.model.dto.RecipePreviewDTO(recipe.name, recipe.diet, recipe.preparationTime, recipe.rating.averageRating) FROM Recipe recipe")
